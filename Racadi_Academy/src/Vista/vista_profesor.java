...
public class vista_profesor {
    ...
    public Profesor pedirDatosProfe() {
        ...
        mostrar = "Por favor ingrese su Contraseña";
        String password = JOptionPane.showInputDialog(mostrar);


        mostrar = "Por favor ingrese su edad";
        mostrar = JOptionPane.showInputDialog(mostrar);
        opciones = Integer.parseInt(mostrar);
        return new Profesor(nombre, segundoNombre, apellido, segundoapellido, correo,password, opciones);
    }
